...
;// CONCATENATED MODULE: ./app/api/auth/signup/route.ts
...
const schema = lib_default().object({
    ...
    username: lib_default().string().required()
});
async function POST(request) {
    ...
    try {
        const ifExist = await User/* default */.Z.findOne({
            email
        });
        if (ifExist) {
            ...
            const createUser = await User/* default */.Z.create({
                email,
                username,
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-app-loader.js?page=%2Fapi%2Fauth%2Fsignup%2Froute&name=app%2Fapi%2Fauth%2Fsignup%2Froute&pagePath=private-next-app-dir%2Fapi%2Fauth%2Fsignup%2Froute.ts&appDir=D%3A%5CProject%5Cfrontend%5Capp&appPaths=%2Fapi%2Fauth%2Fsignup%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=&preferredRegion=&middlewareConfig=e30%3D!
    ...
    const options = {"definition":{"kind":"APP_ROUTE","page":"/api/auth/signup/route","pathname":"/api/auth/signup","filename":"route","bundlePath":"app/api/auth/signup/route"},"resolvedPagePath":"D:\\Project\\frontend\\app\\api\\auth\\signup\\route.ts","nextConfigOutput":""}
...
var __webpack_exports__ = __webpack_require__.X(0, [2697,5501,9335,9289,4989], () => (__webpack_exec__(6033)));
